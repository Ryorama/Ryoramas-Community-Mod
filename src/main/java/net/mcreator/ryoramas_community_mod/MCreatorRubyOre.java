...
public class MCreatorRubyOre extends Elementsryoramas_community_mod.ModElement {
	@ObjectHolder("ryoramas_community_mod:rubyore")
	public static final Block block = null;

	public MCreatorRubyOre(Elementsryoramas_community_mod instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(MCreatorRyorama.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorRubyGem.block, (int) (1)));
		}
	}
